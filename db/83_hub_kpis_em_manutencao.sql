-- ════════════════════════════════════════════════════════════════════════
-- 83_hub_kpis_em_manutencao.sql — card "Em manutenção" no hub P4
--
-- Acrescenta ao hub_kpis a contagem viaturas_em_manutencao (viaturas ATIVAS
-- com situacao_operacional = 'EM_MANUTENCAO', no escopo do usuário), para o
-- novo card "Em manutenção" da tela Apoio Logístico (hub-p4.html).
--
-- Mantém tudo do db/82 (filtro ativo em Frota/Baixadas) e do db/78 (fix TTA).
-- Idempotente. Rodar depois do 82.
-- ════════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════════
-- FIM. Ordem no SQL Editor: depois do 82 (supersede a versão anterior).
-- ════════════════════════════════════════════════════════════════════════
