-- ══════════════════════════════════════════════════════════════════════
--  93_relatorio_meus_comandante.sql — campo "Comandante" na lista de relatórios
--
--  Na tela Meus Relatórios, para identificar um relatório sem abrir Ver/Imprimir,
--  a lista passa a exibir o COMANDANTE da equipe. Aqui recriamos relatorio_meus
--  (db/79) apenas ACRESCENTANDO o campo 'Comandante' (r.comandante) ao JSON.
--  Escopo/visibilidade e demais campos idênticos ao db/79.
--
--  Idempotente. Rodar no SQL Editor depois do 79.
-- ══════════════════════════════════════════════════════════════════════
...
-- ══════════════════════════════════════════════════════════════════════
-- FIM. Ordem no SQL Editor: depois do 79.
-- ══════════════════════════════════════════════════════════════════════
